...
async def onboarding_experience(
    *,
    ...
    for action in actions:
        ...
        elif status in {"blocked", "skipped", "declined", "failed", "stopped"}:
        ...
        view["first_deliverables"].append(
            {
                ...
                "schedule": schedule,
                "next_run_at": next_run.isoformat() if next_run else action.get("next_run_at"),
                "result_links": links,
